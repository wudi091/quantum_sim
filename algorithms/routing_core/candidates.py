"""Build simulator-neutral candidate expansions for online policies."""
...
class PlanningBatchProblem:
    """One candidate--resource problem before choosing an online policy."""
    ...
    def request_censoring_latency_map(self) -> dict[str, float]:
        ...
        Keeping this catalogue beside the candidate expansion lets all online
        policies use the same physical candidate representation.
        """
...
def build_planning_batch_problem(
    ...
    *,
    ...
    """Build the candidate expansion shared by online policies."""
    ...
    # Keep the censoring boundary in the problem description for online
    # policies that need to account for requests still waiting at the horizon.
