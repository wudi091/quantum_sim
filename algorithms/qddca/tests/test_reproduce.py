...
from algorithms.qddca.reproduce import OFFICIAL, _meets_threshold, _shape_stats, run_suite
...
class QDDCATrendTests(unittest.TestCase):
    ...
    def test_window_throughput_correlation_is_required_for_overall_pass(self):
        ...
        with patch("algorithms.qddca.reproduce.run_case", side_effect=fake_case):
